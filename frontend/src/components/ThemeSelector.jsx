  ...
  if (theme.hue === 'rainbow' || theme.hue === 'disco' || theme.hue === 'icecream') {
    ...
    if (theme.hue === 'rainbow') {
      ...
      style.textContent = [
        ...
        '5% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '10% { --primary: 60 100% 50%; --accent: 60 100% 50%; --ring: 60 100% 50%; }',
        '15% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '20% { --primary: 150 100% 50%; --accent: 150 100% 50%; --ring: 150 100% 50%; }',
        '25% { --primary: 280 100% 60%; --accent: 280 100% 60%; --ring: 280 100% 60%; }',
        '30% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '35% { --primary: 190 100% 50%; --accent: 190 100% 50%; --ring: 190 100% 50%; }',
        '40% { --primary: 0 100% 50%; --accent: 0 100% 50%; --ring: 0 100% 50%; }',
        '45% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '50% { --primary: 45 100% 50%; --accent: 45 100% 50%; --ring: 45 100% 50%; }',
        '55% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '60% { --primary: 210 100% 55%; --accent: 210 100% 55%; --ring: 210 100% 55%; }',
        '65% { --primary: 300 100% 55%; --accent: 300 100% 55%; --ring: 300 100% 55%; }',
        '70% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '75% { --primary: 120 100% 45%; --accent: 120 100% 45%; --ring: 120 100% 45%; }',
        '80% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
        '85% { --primary: 15 100% 55%; --accent: 15 100% 55%; --ring: 15 100% 55%; }',
        '90% { --primary: 260 100% 60%; --accent: 260 100% 60%; --ring: 260 100% 60%; }',
        '95% { --primary: 0 0% 100%; --accent: 0 0% 100%; --ring: 0 0% 100%; }',
